...
@interface NewsVisitViewController ()


@end

@implementation NewsVisitViewController
...
- (void)loadAndhandleData
{
    ...
    NSString * url = [NSString stringWithFormat:@"%@?page=%d&news_id=%ld", kGetNewsVisitListPath, self.currentPage, self.newsId];
    debugLog(@"%@", url);
