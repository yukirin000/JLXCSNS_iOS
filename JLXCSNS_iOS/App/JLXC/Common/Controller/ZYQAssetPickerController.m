...
- (void)setupViews
{
    ...
    titleLabel.textColor = [UIColor colorWithHexString:ColorBrown];
...
- (void)setupButtons
{
    ...
    self.navigationController.navigationBar.tintColor = [UIColor colorWithHexString:ColorBrown];
...
- (void)setupViews
{
    ...
    [self.navigationController.navigationBar setBackgroundImage:[UIImage imageNamed:@"default_back_image"] forBarMetrics:UIBarMetricsDefault];
